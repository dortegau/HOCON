...
var grammar = {
    ...
    "lex": {
        ...
        "rules": [
            ...
            ["'''(?:{esc}[\"bfnrt/{esc}]|{esc}u[a-fA-F0-9]{4}|[^\"{esc}]|{breakline})*'''", "yytext = yytext.substr(3, yyleng-6); return 'MULTILINE_STRING';"],
            ["\\{", "return '{'"],
            ["\\}", "return '}'"],
            ["\\[", "return '['"],
            ["\\]", "return ']'"],
    ...
    "bnf": {
        ...
        "HOCONMultilineString": [[ "MULTILINE_STRING", "$$ = yytext;" ]],
